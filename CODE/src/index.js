            ...
            code
                = code.replace(
                        ...
                        ) =>
                    {
                        ...
                        let value = this.getValue( suffix );
                        suffix = suffix.slice( value.length );
                        ...
                        return (
                            ...
                            + variable
                            + ", set"
                            + variable.slice( 0, 1 ).toUpperCase()
                            + variable.slice( 1 )
                            + '] = '
                            + createStateFunction
                            + '('
...
export function isBlankCharacter(
    character
    )
{
    return (
    ...
    )
{
    ...
    return processor.getProcessedCode( code, framework );
}
